...
import { db as firestore } from "./config" // Alias correcto
 ...
 */
export async function guardarFotoPerfil(email: string, fotoUrl: string): Promise<void> {
 ...
 */
export async function obtenerFotoPerfil(email: string): Promise<string | null> {
